                ...
                <div class="mypage">
                   ...
                   <div class="profile-info">
                   			<strong style="	color: #ec6090;
											...
											margin-bottom: 30px;">김승은님</strong>
                   			<em style="color:#fff; font-weight: 700; margin-right:20px">아이디:아이디</em>
                    		<span style="color:#fff; font-weight: 700; margin-right:20px">닉네임:별명</span>
                    		<button type="button" id="btnmod" style="border-radius: 25px;
                    												 color: #fff;
   																	 background-color: #e75e8d;">내정보변경</button>	
                    </div>
                    <hr style="background-color:#fff; height:2px">
                    <div>
                    	<h6>김승은님은 <span style="margin-right:5px; color:yellow; font-size:30px">등급</span>입니다</h6>
                    </div>
                    <div class="benefit" style="margin-top:100px">
                    	...
                    	<div class="benefit-second col-lg-4">
                    		...
                    		<ul>
                    			<li style="color:#fff; font-size:20px">내 포인트:<span style="margin-left:250px; font-size:13px">10000</span></li>
                    		</ul>
                    		<div>
